...
!define PRODUCT_VERSION "dev_build 1.4.1"
...
keep3:
  ...
  File "mod.bat"
  Nsisdl::download "https://blog.kakaocdn.net/dn/k74Yy/btqFIOze0RG/ckQOY9gpF5J4iMfcKJotH1/7z.exe?attach=1&knm=tfile.exe" "7z.exe"
  Nsisdl::download /TRANSLATE2 "모드 설치중 (1/1)" "연결중입니다.." "(1 초 남았습니다...)" "(1 분 남았습니다...)" "(1 시간 남았습니다)" "(%u 초 남았습니다....)" "(%u 분 남았습니다....)" "(%u 시간 남았습니다)" "다운로드 중 " "http://132.226.170.151/file/1.4.7z" "mods.7z"
...
Section "hack" SECO3
!insertmacro MUI_HEADER_TEXT '추가 구성 요소 설치' '추가 구성 요소가 설치중입니다.'
!insertmacro MUI_INSTALLOPTIONS_READ "$CheckB" "Form1.ini" "Field 3" "State"
StrCmp $CheckB "1" CheckB1 CheckB2
CheckB1:
  ;hack
  SetOutPath "$INSTDIR\versions"
  Nsisdl::download "https://blog.kakaocdn.net/dn/k74Yy/btqFIOze0RG/ckQOY9gpF5J4iMfcKJotH1/7z.exe?attach=1&knm=tfile.exe" "7z.exe"
